...
module top ;
	...
	wire [0:0] tmpOE__rxPin_net;
	wire [0:0] tmpIO_0__rxPin_net;
	wire [0:0] tmpINTERRUPT_0__rxPin_net;
	electrical [0:0] tmpSIOVREF__rxPin_net;
	...
	cy_psoc3_pins_v1_10
		...
		rxPin
		 (.oe(tmpOE__rxPin_net),
		  .y({1'b0}),
		  .fb({Net_339}),
		  .io({tmpIO_0__rxPin_net[0:0]}),
		  .siovref(tmpSIOVREF__rxPin_net),
		  .interrupt({tmpINTERRUPT_0__rxPin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__rxPin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__txPin_net;
	wire [0:0] tmpFB_0__txPin_net;
	wire [0:0] tmpIO_0__txPin_net;
	wire [0:0] tmpINTERRUPT_0__txPin_net;
	electrical [0:0] tmpSIOVREF__txPin_net;
	...
	cy_psoc3_pins_v1_10
		...
		txPin
		 (.oe(tmpOE__txPin_net),
		  .y({Net_334}),
		  .fb({tmpFB_0__txPin_net[0:0]}),
		  .io({tmpIO_0__txPin_net[0:0]}),
		  .siovref(tmpSIOVREF__txPin_net),
		  .interrupt({tmpINTERRUPT_0__txPin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__txPin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__servoPin_net;
	wire [0:0] tmpFB_0__servoPin_net;
	wire [0:0] tmpIO_0__servoPin_net;
	wire [0:0] tmpINTERRUPT_0__servoPin_net;
	electrical [0:0] tmpSIOVREF__servoPin_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		servoPin
		 (.oe(tmpOE__servoPin_net),
		  .y({Net_330}),
		  .fb({tmpFB_0__servoPin_net[0:0]}),
		  .io({tmpIO_0__servoPin_net[0:0]}),
		  .siovref(tmpSIOVREF__servoPin_net),
		  .interrupt({tmpINTERRUPT_0__servoPin_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__servoPin_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("9c1914b7-84c7-434d-8130-3eb6c7a762f9"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("100000000000"),
		  .is_direct(0),
    ...
    PWM_v3_30_0 servoPWM (
        ...
        .ph1(Net_331),
        .ph2(Net_332));
    defparam servoPWM.Resolution = 8;
