...
#define prvBASE_ROT_P   'c'
#define prvBASE_ROT_M   'd'
#define prvBASE_ELE_P   'h'
#define prvBASE_ELE_M   'g'
#define prvELBOW_P      'l'
#define prvELBOW_M      'k'
#define prvWRIST_ROLL_P 'f'
#define prvWRIST_ROLL_M 'e'
#define prvWRIST_PTCH_P 'a'
#define prvWRIST_PTCH_M 'b'
#define prvGRAB_OPEN    'i'
#define prvGRAB_CLOSE   'j'
#define prvMODE_CH      'm'
#define prvSAVE         'p'
#define prvRUN          'p'
#define prvCLR          'o'
