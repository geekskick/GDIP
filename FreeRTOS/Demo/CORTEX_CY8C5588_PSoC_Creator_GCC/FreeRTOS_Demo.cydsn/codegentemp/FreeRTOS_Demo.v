...
// CharLCD_v2_20(ConversionRoutines=true, CUSTOM0=0,E,8,8,8,E,0, CUSTOM1=0,A,A,4,4,4,0, CUSTOM2=0,E,A,E,8,8,0, CUSTOM3=0,E,A,C,A,A,0, CUSTOM4=0,E,8,C,8,E,0, CUSTOM5=0,E,8,E,2,E,0, CUSTOM6=0,E,8,E,2,E,0, CUSTOM7=0,4,4,4,0,4,0, CustomCharacterSet=0, TypeReplacementString=uint8, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=CharLCD_v2_20, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=LCD_Character_Display, CY_INSTANCE_SHORT_NAME=LCD_Character_Display, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=20, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=LCD_Character_Display, )
module CharLCD_v2_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("a774cbee-f634-4288-91e6-9ae6a6f16e58/ed092b9b-d398-4703-be89-cebf998501f6"),
...
// PWM_v3_30(CaptureMode=0, Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, Compare1_16=true, Compare1_8=false, Compare2_16=false, Compare2_8=false, CompareStatusEdgeSense=true, CompareType1=1, CompareType1Software=0, CompareType2=1, CompareType2Software=0, CompareValue1=250, CompareValue2=63, CONTROL3=0, ControlReg=true, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeadBand=0, DeadBand2_4=0, DeadBand256=0, DeadBandUsed=0, DeadTime=1, DitherOffset=0, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, InterruptOnCMP1=false, InterruptOnCMP2=false, InterruptOnKill=false, InterruptOnTC=false, IntOnCMP1=0, IntOnCMP2=0, IntOnKill=0, IntOnTC=0, KillMode=0, KillModeMinTime=0, MinimumKillTime=1, OneCompare=true, Period=501, PWMMode=0, PWMModeCenterAligned=0, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=sSTSReg_rstSts, RunMode=0, Status=true, TermMode_capture=0, TermMode_clock=0, TermMode_cmp_sel=0, TermMode_enable=0, TermMode_interrupt=0, TermMode_kill=0, TermMode_ph1=0, TermMode_ph2=0, TermMode_pwm=0, TermMode_pwm1=0, TermMode_pwm2=0, TermMode_reset=0, TermMode_tc=0, TermMode_trigger=0, TermVisibility_capture=false, TermVisibility_clock=true, TermVisibility_cmp_sel=false, TermVisibility_enable=false, TermVisibility_interrupt=true, TermVisibility_kill=false, TermVisibility_ph1=false, TermVisibility_ph2=false, TermVisibility_pwm=true, TermVisibility_pwm1=false, TermVisibility_pwm2=false, TermVisibility_reset=true, TermVisibility_tc=true, TermVisibility_trigger=false, TriggerMode=0, UDB16=true, UDB8=false, UseControl=true, UseInterrupt=true, UseStatus=true, VerilogSectionReplacementString=sP16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=PWM_v3_30, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=High_Frequency_PWM_1, CY_INSTANCE_SHORT_NAME=High_Frequency_PWM_1, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=30, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=High_Frequency_PWM_1, )
module PWM_v3_30_3 (
    reset,
    clock,
    tc,
...
// Timer_v2_70(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=true, CaptureMode=1, CONTROL3=1, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC5, EnableMode=0, FF16=true, FF8=false, FixedFunction=true, FixedFunctionUsed=1, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=false, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=0, NumberOfCaptures=1, param45=1, Period=65535, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=0, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=false, TriggerMode=0, UDB16=false, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=false, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=Timer_v2_70, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_48MHz, CY_INSTANCE_SHORT_NAME=Timer_48MHz, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=70, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=Timer_48MHz, )
...
module top ;
	...
	wire [0:0] tmpOE__Pin_LED_0_net;
	wire [0:0] tmpFB_0__Pin_LED_0_net;
	wire [0:0] tmpIO_0__Pin_LED_0_net;
	wire [0:0] tmpINTERRUPT_0__Pin_LED_0_net;
	electrical [0:0] tmpSIOVREF__Pin_LED_0_net;

	cy_psoc3_pins_v1_10
		#(.id("dd8e7b7a-4555-4c6e-b975-b71c8ba57ccc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_LED_0
		 (.oe(tmpOE__Pin_LED_0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_LED_0_net[0:0]}),
		  .io({tmpIO_0__Pin_LED_0_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_LED_0_net),
		  .interrupt({tmpINTERRUPT_0__Pin_LED_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_LED_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("e887b5b1-e747-416b-a086-8910d8e44d24"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    PWM_v3_30_1 High_Frequency_PWM_0 (
        .reset(Net_67),
        .clock(Net_46),
        .tc(Net_222),
        .pwm1(Net_223),
        ...
        .ph1(Net_232),
        .ph2(Net_233));
    defparam High_Frequency_PWM_0.Resolution = 16;


	cy_clock_v1_0
		#(.id("16465fff-93f5-4c78-8944-af8d5834c9da"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	cy_isr_v1_0
		#(.int_type(2'b00))
		isr_High_Frequency_2000Hz
		 (.int_signal(Net_222));


    CharLCD_v2_20_2 LCD_Character_Display ();

	wire [0:0] tmpOE__Pin_LED_2_net;
	wire [0:0] tmpFB_0__Pin_LED_2_net;
	wire [0:0] tmpIO_0__Pin_LED_2_net;
	wire [0:0] tmpINTERRUPT_0__Pin_LED_2_net;
	electrical [0:0] tmpSIOVREF__Pin_LED_2_net;

	cy_psoc3_pins_v1_10
		#(.id("b3ac9170-30ae-409e-a625-ad268e914172"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	assign tmpOE__Pin_LED_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_LED_3_net;
	wire [0:0] tmpFB_0__Pin_LED_3_net;
	wire [0:0] tmpIO_0__Pin_LED_3_net;
	wire [0:0] tmpINTERRUPT_0__Pin_LED_3_net;
	electrical [0:0] tmpSIOVREF__Pin_LED_3_net;

	cy_psoc3_pins_v1_10
		#(.id("289a8dd4-b439-4dcc-b229-17674ce5879f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_LED_3
		 (.oe(tmpOE__Pin_LED_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_LED_3_net[0:0]}),
		  .io({tmpIO_0__Pin_LED_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_LED_3_net),
		  .interrupt({tmpINTERRUPT_0__Pin_LED_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_LED_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    PWM_v3_30_3 High_Frequency_PWM_1 (
        .reset(Net_80),
        .clock(Net_46),
        .tc(Net_235),
        .pwm1(Net_236),
        ...
        .ph1(Net_245),
        .ph2(Net_246));
    defparam High_Frequency_PWM_1.Resolution = 16;
	...
	cy_isr_v1_0
		#(.int_type(2'b00))
		isr_High_Frequency_2001Hz
		 (.int_signal(Net_235));


	wire [0:0] tmpOE__Startup_Release_Switch_net;
	wire [0:0] tmpFB_0__Startup_Release_Switch_net;
	wire [0:0] tmpIO_0__Startup_Release_Switch_net;
	wire [0:0] tmpINTERRUPT_0__Startup_Release_Switch_net;
	electrical [0:0] tmpSIOVREF__Startup_Release_Switch_net;

	cy_psoc3_pins_v1_10
		#(.id("31701add-6005-44d9-ae4e-af20af5e04c1"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .ovt_slew_control(2'b00),
		  .input_buffer_sel(2'b00))
		Startup_Release_Switch
		 (.oe(tmpOE__Startup_Release_Switch_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Startup_Release_Switch_net[0:0]}),
		  .io({tmpIO_0__Startup_Release_Switch_net[0:0]}),
		  .siovref(tmpSIOVREF__Startup_Release_Switch_net),
		  .interrupt({tmpINTERRUPT_0__Startup_Release_Switch_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Startup_Release_Switch_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ZeroTerminal ZeroTerminal_4 (
        .z(Net_197));

    Timer_v2_70_4 Timer_20KHz (
        .reset(Net_197),
        .interrupt(Net_247),
        .enable(1'b1),
        .trigger(1'b1),
        ...
        .tc(Net_252),
        .clock(Net_253));
    defparam Timer_20KHz.CaptureCount = 2;
    defparam Timer_20KHz.CaptureCounterEnabled = 0;
    defparam Timer_20KHz.DeviceFamily = "PSoC5";
    defparam Timer_20KHz.InterruptOnCapture = 0;
    defparam Timer_20KHz.InterruptOnTC = 0;
    defparam Timer_20KHz.Resolution = 16;
    defparam Timer_20KHz.SiliconRevision = "0";
    ...
    Timer_v2_70_5 Timer_48MHz (
        ...
        .tc(Net_260),
        .clock(Net_261));
    defparam Timer_48MHz.CaptureCount = 2;
    defparam Timer_48MHz.CaptureCounterEnabled = 0;
    defparam Timer_48MHz.DeviceFamily = "PSoC5";
    defparam Timer_48MHz.InterruptOnCapture = 0;
    defparam Timer_48MHz.InterruptOnTC = 0;
    defparam Timer_48MHz.Resolution = 16;
    defparam Timer_48MHz.SiliconRevision = "0";


	cy_clock_v1_0
		#(.id("831ee977-2b67-4267-95e3-d18001dd07c3"),
		  .source_clock_id("75C2148C-3656-4d8a-846D-0CAE99AB6FF7"),
		  .divisor(0),
		  .period("0"),
		  .is_direct(1),
